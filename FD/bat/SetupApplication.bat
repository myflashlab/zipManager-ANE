...
:: Android packaging
set AND_CERT_NAME="exZipManager"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exZipManager.p12
...
set IOS_PROVISION=cert\Extension_ZipManager.mobileprovision
...
set APP_ID=com.doitflash.exZipManager

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exZipManager
